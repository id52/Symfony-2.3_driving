...
class QuestionController extends AbstractEntityController
{
    ...
    public function listAction()
    {
        ...
        $fb = $form_factory->createNamedBuilder('question', 'form', array(), array('csrf_protection' => false))
        ...
        if ($data = $filter_form->get('question')->getData()) {
            $qb->andWhere('e.text LIKE :question')->setParameter('question', '%'.$data.'%');
        }
