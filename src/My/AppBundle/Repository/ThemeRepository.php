...
class ThemeRepository extends SortableRepository
{
    public function getAllGrouping()
    {
        ...
        $themes = array();
        foreach ($themes_q as $theme) { /** @var $theme \My\AppBundle\Entity\Theme */
    ...
    public function isReaderExists(Theme $theme, User $user)
    {
        $qb = $this->createQueryBuilder('t')
            ...
            ->andWhere('r.theme = :theme')->setParameter(':theme', $theme)
            ->andWhere('r.reader = :user')->setParameter(':user', $user)
        ;
