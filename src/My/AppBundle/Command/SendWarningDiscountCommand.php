...
class SendWarningDiscountCommand extends ContainerAwareCommand
{
    ...
    protected $notify;
    /** @var $settingsNotifies \My\AppBundle\Repository\SettingNotifyRepository */
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->settingsNotifies = $this->em->getRepository('AppBundle:Setting');
    ...
    protected function send(Region $region, $days, $type)
    {
        ...
        $end_time = $now->format('d.m.Y 23:59:59');
        ...
        $sms = $this->settingsNotifies->get('discount_2_warning_sms_'.$type);
        $email_subject = $this->settingsNotifies->get('discount_2_warning_'.$type.'_email_title');
        $email_message = $this->settingsNotifies->get('discount_2_warning_'.$type.'_email_text');
        ...
        foreach ($users as $user) {
            ...
            $this->notify->sendEmail($user, $email_subject, $message);
