...
class SendMissingDiscountCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $sms = $settings_notifies_repository->get('discount_2_missing_sms');
        $email_subject = $settings_notifies_repository->get('discount_2_missing_email_title');
        $email_message = $settings_notifies_repository->get('discount_2_missing_email_text');
        ...
        foreach ($regions as $region) {
            ...
            if ($region->isDiscount2SecondEnabled()) {
                ...
                foreach ($users as $user) {
                    ...
                    $notify->sendEmail($user, $email_subject, $message);
