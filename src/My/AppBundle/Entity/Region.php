...
class Region extends RegionModel
{
    ...
    protected $filial_existing = false;
    ...
    public function isDiscount1Enabled()
    {
        $today = new \DateTime('today');
        return ($this->getDiscount1DateFrom() <= $today && $today <= $this->getDiscount1DateTo())
            || $this->getDiscount1TimerPeriod() > 0;
    }
